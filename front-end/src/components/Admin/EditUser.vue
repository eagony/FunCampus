  ...
  <div>
    ...
    <form @submit.prevent="onSubmit">
      <div v-if="user" class="form-group">
        ...
        <input id="username" :value="user.username" class="form-control form-control-md rounded-0" type="text" disabled="">
      </div>
      ...
      <div class="form-group">
        ...
        <div>
          <!-- Inline Radios -->
          <label v-for="(role, index) in roles.items" :key="index" class="form-check-inline u-check g-pl-25 ml-0 g-mr-25">
            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" name="role_id" type="radio" :id="role.id" :value="role.id" v-model="picked">
      ...
      this.$axios.put(path, payload)
        .then((response) => {
          ...
          this.$message({
            center: true,
            showClose: true,
            message: 'Successed modify the user.', 
            type: 'success'
          })
